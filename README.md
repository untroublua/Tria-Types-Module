...
## Setup
Throw the module somewhere under your map model and, in every script that uses MapLib, require this module and cast MapLib to the MapLib type
...
```lua
local Types = require "./Modules/Types" -- so it was pretty much script.Parent.Modules.Types
